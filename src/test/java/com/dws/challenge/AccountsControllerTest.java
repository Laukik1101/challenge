...
class AccountsControllerTest {
	...
	void transfer() throws Exception {
		...
		//Account 1
		this.mockMvc.perform(post("/v1/accounts").contentType(MediaType.APPLICATION_JSON)
				.content("{\"accountId\":\"Id-4321\",\"balance\":2000}")).andExpect(status().isCreated());
		...
		this.mockMvc
				.perform(post("/v1/accounts/transfer").contentType(MediaType.APPLICATION_JSON)
						.content("{\"accountFromId\":\"Id-4321\",\"accountToId\":\"Id-1234\",\"amount\": 200}"))
				.andExpect(status().isOk());
		Account accountFrom = accountsService.getAccount("Id-4321");
	...
	@Test
	void transferNegativeBalance() throws Exception {
		this.mockMvc.perform(post("/v1/accounts/transfer").contentType(MediaType.APPLICATION_JSON)
				.content("{\"accountFromId\":\"Id-4321\",\"accountToId\":\"Id-1234\",\"amount\": -2000}")).andExpect(status().isBadRequest());
	}
}
